...
- Feat: AWS Bedrock backend -- `graphify extract ./docs --backend bedrock`; credentials use the standard AWS provider chain; model via `GRAPHIFY_BEDROCK_MODEL`; `[bedrock]` extra adds boto3
