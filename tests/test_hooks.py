...
def test_codex_session_start_outputs_pending_context(tmp_path):
    ...
    assert "graphify extract . --backend ollama --model kimi-k2.7-code:cloud" in context
    assert "graphify cluster-only . --backend ollama --model kimi-k2.7-code:cloud" in context
