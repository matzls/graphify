...
- **Global scope**: `/Users/mase/Codebase/Personal-Projects/graphify/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/mase/Codebase/Personal-Projects/graphify/.codex/notes/`)
...
2. Glob `/Users/mase/Codebase/Personal-Projects/graphify/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/mase/Codebase/Personal-Projects/graphify/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/mase/Codebase/Personal-Projects/graphify/.codex/notes/` — works in any directory
