...
```
Agent(
  prompt="Read /Users/mase/Codebase/Personal-Projects/graphify/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mase/Codebase/Personal-Projects/graphify/.codex/get-shit-done/templates/SECURITY.md`
