...
```bash
INIT=$(node "/Users/mase/Codebase/Personal-Projects/graphify/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/mase/Codebase/Personal-Projects/graphify/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
