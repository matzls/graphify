...
```bash
INIT=$(node "/Users/mase/Codebase/Personal-Projects/graphify/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/mase/Codebase/Personal-Projects/graphify/.codex/get-shit-done/templates/spec.md.
